...
def get_params():
    ...
    args.add_argument("--gama", default=0.5, type=float)
    ...
    args.add_argument("-eval_epo", "--eval_epoch", default=200, type=int)
    args.add_argument("-ckpt_epo", "--checkpoint_epoch", default=200, type=int)
...
data_dir = {
    ...
    "ent2ids": "/ent2ids",
    "ent2vec": "/ent2vec.npy",
    'train_rel_dic':'/train_rel_dic.json'
}
